...
WebUI.click(findTestObject('Object Repository/Try2/Page_Office of Regulatory Affairs - Clinical Trial Agreements/td_CTA V3 Administration'))
...
WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/select_- None -                                        Clinical Trial AgreementConfidentiality AgreementEvaluation AgreementLetter of AgreementMaterial Transfer AgreementMemorandum of UnderstandingNon-Clinical StudyQuali'), 
    'Clinical Trial Agreement', true)

WebUI.click(findTestObject('Object Repository/Try2/Page_DAIT - ORA - Clinical Trial Agreements/td_Multi-Company'))

WebUI.click(findTestObject('Object Repository/Try2/Page_DAIT - ORA - Clinical Trial Agreements/input_YesNo__1_1_20_1'))

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/select_- None -20  20 Genesystems3SBioABT Holding CompanyAchaogenAeolus Pharmaceuticals IncAimmune TherapeuticsAlentic Microscience IncAlexion PharmaceuticalsALK-Abello ASAllergan PlcAllerteinAmgenAngion IncAraim Pharmac'), 
    'ABT Holding Company', true)

WebUI.setText(findTestObject('Object Repository/Try2/Page_DAIT - ORA - Clinical Trial Agreements/input_Regulatory Officer__1_1_5_1_Name'), 
    'tahili')

WebUI.click(findTestObject('Object Repository/Try2/Page_DAIT - ORA - Clinical Trial Agreements/a_Tahiliani Shalini (tahilianis2)'))

WebUI.click(findTestObject('Object Repository/Try2/Page_DAIT - ORA - Clinical Trial Agreements/input_Comments_btnButton1'))
