...
WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddCompany1'), '20 / 20 Genesystems', 
    true)

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddProduct1_1'), '3-D tissues \\(platform technologies\\)', 
    true)

WebUI.click(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/img_T19380001_addrow_1_1_21_1'))

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddCompany2'), 'Amgen', true)

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddProduct2_1'), 'Amb a 1', true)

WebUI.click(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/img_T19380001_addrow_1_1_21_2_24_1'))

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddProduct2_2'), 'AEOL 10150', true)

WebUI.click(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/img_T19380001_addrow_1_1_21_2_24_2'))

WebUI.selectOptionByValue(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/ddProduct2_3'), 'ARQ 900', true)

WebUI.click(findTestObject('Object Repository/Page_DAIT - ORA - Clinical Trial Agreements/clickTable'))
...
WebUI.setText(findTestObject('Page_DAIT - ORA - Clinical Trial Agreements/textarea_Comments_tcomments'), 'Initiated agreement')
